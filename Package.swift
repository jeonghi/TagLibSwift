...
let package = Package(
    ...
    targets: [
        ...
        // scripts/generate-flat-headers.sh) as its public headers.
        .target(
            name: "CTagLibCore",
        ...
        // extern "C" bridge over TagLib. Consumes CTagLibCore's flat C++ headers
        // internally, but exposes ONLY the pure C header taglib_c_bridge.h, so
        // TagLibSwift stays a pure C module (no C++ interop leakage).
        .target(
            name: "CTagLibBridge",
            dependencies: ["CTagLibCore"],
            path: "Sources/CTagLibBridge",
            publicHeadersPath: "include"
        ),
        // Pure Swift public API. UNCHANGED behavior. Imports the pure C module
        // CTagLibBridge. NO C++ interop.
        .target(
            name: "TagLibSwift",
